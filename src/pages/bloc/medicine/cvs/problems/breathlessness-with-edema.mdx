...
1. **Oxygen Therapy**: Administer oxygen if SpO2 < 94%. CPAP or BiPAP if the patient is in respiratory distress.
...
2. **Diuretics**: IV `furosemide` to reduce fluid overload.
