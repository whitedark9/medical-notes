...
1. **Unstable Angina:** Chest pain at rest or with minimal exertion, not relieved by nitroglycerin.
2. **Non-ST Elevation Myocardial Infarction (NSTEMI):** Chest pain with elevated cardiac biomarkers but no ST elevation on ECG.
3. **ST Elevation Myocardial Infarction (STEMI):** Chest pain with ST elevation on ECG and elevated cardiac biomarkers.
...
- **Pathophysiology**:
  ...
  - Formation of thrombus leading to occlusion (in AMI)
  - Reduced blood flow causing myocardial ischemia (in unstable angina)
...
- **Pathophysiology**:
  ...
  - Causes include viral infection, autoimmune disease, and post-MI syndrome
