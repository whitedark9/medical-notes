...
## 1. Classification of Haematuria
...
| -------------- | --------------------------- | -------------------------- |
| Macroscopic    | Visible blood in urine      | Any part of urinary tract  |
| Microscopic    | Blood detected by lab tests | Any part, often incidental |
| Initial        | Blood at start              | Urethra                    |
| Terminal       | Blood at end                | Bladder neck, prostate     |
| Total          | Blood throughout            | Kidney, bladder            |
| Glomerular     | From kidney glomeruli       | Glomerulonephritis, etc.   |
| Non-Glomerular | From urinary tract          | Stone, tumor, infection    |
