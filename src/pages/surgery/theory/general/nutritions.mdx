...
1. **Gastrostomy (PEG/PRG)**: Tube placed into the stomach via the abdominal wall.
...
## Indications of Enteral & Parenteral Nutrition

| Indication                                                   | Enteral Nutrition (EN) | Parenteral Nutrition (PN) |
| ------------------------------------------------------------ | ---------------------- | ------------------------- |
| Functional GI tract but patient unable to eat                | ✅ Preferred           | ❌ Not needed             |
| Dysphagia (e.g., stroke, head injury)                        | ✅                     | ❌                        |
| Prolonged anorexia or inadequate oral intake                 | ✅                     | ❌                        |
| Severe burns, trauma, sepsis (if gut works)                  | ✅                     | ❌                        |
| Postoperative nutrition (if early oral feeding not possible) | ✅                     | ❌                        |
...
## Key Differences Between Enteral & Parenteral Nutrition

| Aspect         | Enteral Nutrition (EN)                      | Parenteral Nutrition (PN)          |
| -------------- | ------------------------------------------- | ---------------------------------- |
| Route          | GI tract (tube feeding)                     | Intravenous (IV)                   |
| Indication     | Functional gut but oral intake not possible | Non-functional gut                 |
| Preferred?     | ✅ Yes (if GI tract is functional)          | ❌ No (last resort)                |
| Infection Risk | Low                                         | High (catheter-related infections) |
| Cost           | Lower                                       | Higher                             |
