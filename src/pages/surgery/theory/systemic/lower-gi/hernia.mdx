...
- **Elective surgery** (if successfully reduced):
  - `Open mesh repair` (Lichtenstein)
  - `Laparoscopic repair` (TEP/TAPP)
- **Emergency surgery** (if irreducible or failed taxis):
...
### If Hernia Becomes Strangulated
...
- Monitor urine output (risk of hypovolemia)

##### B. Surgical Intervention

- **Urgent exploration**:
  - **Assess viability**: Dusky, no peristalsis, loss of sheen → resection.
  - **Mesh use contraindicated** if infection or contamination → use tissue repair (e.g., Bassini).
...
- **Irreducible hernia (non-strangulated)** → good prognosis with timely surgery
- **Strangulated hernia** → worse prognosis if delayed → high morbidity (sepsis, bowel loss)
