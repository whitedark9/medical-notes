...
- `Physiotherapy` and `occupational therapy` to maintain joint mobility
- **Cervical spine involvement**: careful assessment before intubation or surgery (atlantoaxial instability)
- **Osteoporosis prevention**: calcium/vitamin D supplementation, bisphosphonates for those on long-term steroids
- **Cardiovascular risk reduction**: manage hypertension, hyperlipidaemia, diabetes; encourage physical activity
