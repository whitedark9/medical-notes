...
1. If inadequately response to above therapy, `monoclonal antibody belimumab` IV
1. Address poor sleep hygiene

### Severe and Life-threatening Disease

> `High dose glucocorticoids` **and** `Immunosuppressants` for renal, CNS, cardiac involvement.
...
- `Oral prednisolone` 40-60 mg daily, gradually reducing to 10-15 mg/day or less by 3 months **OR**
- `Azathioprine` (2-2.5 mg/kg/day) **OR** `MTX` (10-25 mg/week) **OR** `MMF` (2-3 g/day)
