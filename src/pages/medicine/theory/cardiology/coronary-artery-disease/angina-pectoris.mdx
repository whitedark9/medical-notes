...
|                           | High risk                 | Low risk               |
| :------------------------ | :------------------------ | :--------------------- |
| Symptoms                  | Recent-onset (< 6 months) | Long-standing          |
| CCS classification        | Class II to IV            | Class I                |
| Diabetes mellitus         | Present                   | Absent                 |
| Comorbidity               | Present                   | Absent                 |
| Angina                    | Post-infarct              | Predictable exertional |
| Ischaemia                 | At low workload           | Only at high workload  |
| Vessel disease            | Left main or three        | Single or two          |
| Left ventricular function | Poor                      | Good                   |
