...
- `Fondaparinux`/`LMW heparin` SC, Consider `nitrate` IV perfusion → **Calculate GRACE score**: In-hospital death → Medium to high-risk ACS?
  - If _Yes_: **Early in-hospital coronary angiography** + consider `GP IIb/IIa receptor antagonist` IV infusion → **Maintenance in-hospital medication**
  - If ~~No~~: Recurrent symptoms?
    ...
    - If ~~No~~: **Maintenance in-hospital medication**
