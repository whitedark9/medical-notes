...
- **Challenge tests**: Airway hyper-reactivity (AHR) has higher negative value
- **Exercise tests**: if symptoms are related to exercise
- **Measurement of exhaled nitric oxide (FeNO)**: Elevated in patients who are highly likely to respond to glucocorticoids
- **Skin-prick tests or measurement of total and allergen-specific IgE**: To detect peripheral blood eosinophilia or atopy
